        ...
        container('jnlp') {
          ...
          script {
            ...
            scmVars = git branch: "${BRANCH_NAME}",
                          ...
                          url: 'git@github.com:Patrick-Tech-SH/Back-end.git'
          } // End script
        } // End container
      } // End steps
    } // End stage
            ...
            container('helm') {
                script {
                    ...
                    sh "helm template -f k8s/helm-values/values-backend-${ENV_NAME}.yaml \
                        ...
                        --namespace gkey-market-${ENV_NAME} backend-service-${ENV_NAME} k8s/helm \
        ...
        container('docker') {
          script {
            ...
            docker.withRegistry('https://ghcr.io', 'github-registry') {
              ...
              docker.build('ghcr.io/Patrick-Tech-SH/Back-end:${ENV_NAME}').push()
